						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#productionorder-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"productionorder-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=productionorder",
									"url": sap.ui.require.toUrl("productionorder")
								}
							}
						}
					}
