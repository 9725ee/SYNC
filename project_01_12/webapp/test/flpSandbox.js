		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Router",
									"targetURL": "#syncproject0112-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncproject0112-display": {
								"semanticObject": "syncproject0112",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.project0112",
									"url": sap.ui.require.toUrl("sync/project0112")
								}
							}
						}
					}
