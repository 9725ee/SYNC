		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData CRUD",
									"targetURL": "#odataproject0113-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odataproject0113-display": {
								"semanticObject": "odataproject0113",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odata.project0113",
									"url": sap.ui.require.toUrl("odata/project0113")
								}
							}
						}
					}
