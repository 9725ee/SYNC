		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Product Progrtam (01)",
									"targetURL": "#examexprogram01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"examexprogram01-display": {
								"semanticObject": "examexprogram01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=exam.exprogram01",
									"url": sap.ui.require.toUrl("exam/exprogram01")
								}
							}
						}
					}
