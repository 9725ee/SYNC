		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Connection",
									"targetURL": "#syncproject0102-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"syncproject0102-display": {
								"semanticObject": "syncproject0102",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.project0102",
									"url": sap.ui.require.toUrl("sync/project0102")
								}
							}
						}
					}
